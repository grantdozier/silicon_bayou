...
export const services = [
  {
    ...
    what: [
      ...
      'We close that gap by building a Model Context Protocol server over your systems. Claude gets a set of named, schema-validated tools: read the schedule, search the inbox, pull job costing, list open RFIs. Every call is scoped to the person asking and written to an audit trail.',
    ],
    get: [
      ...
      'Agents that draft and queue for approval, so nothing leaves without a human',
    ...
    practice: {
      ...
      metrics: [
        ['10 to 20 hrs', 'Saved per person, per project'],
...

  {
    ...
    get: [
      ...
      'Draft-only by default, so nothing leaves without a person',
...

  {
    ...
    practice: {
      ...
      metrics: [
        ...
        ['15 to 25 days', 'Off the project timeline'],
      ],
    },
  },
...

  {
    ...
    get: [
      ...
      'Honest build-versus-buy, because often the answer is a better prompt',
...

  {
    ...
    practice: {
      title: 'Royal Engineering',
      body: 'A React front end and a .NET API that ingests up to 300 PSDDF and SETTLE3 model files at once, extracts and structures the settlement data with no manual entry, and generates the complete Excel workbook, with graphs, calculations, and sea-level-rise adjustments included.',
      metrics: [
        ['Weeks → Minutes', 'Turnaround'],
